...
public class DrawUtil {
    ...
    /**
     * Returns n or n+1 points along a line. <p>
     *
     * @param pt1 point
     * @param pt2 point
     * @param n count
    ...
    /**
     * Bresenham's line algorithm. <p> Returns an array of points to draw. <p>
     *
     * @param pt1 point
     * @param pt2 point
     * @return Point[]
    ...
    /**
     * Tests if a point is inside a polygon. <p>
     *
     ...
     * Poly (int[] xpts, int[] ypts). <p> This procedure assumes that
     * xpts.length == ypts.length. <p>
     *
    ...
    /**
     * Compute perpendicular distance from point to line. <p>
     *
    ...
    /**
     * Computes the distance from a point to a line segment. <p> Variable usage
     * as follows: <p> <ul> <li>x12 x distance from the first endpoint to the
     * second. <li>y12 y distance from the first endpoint to the second. <li>x13
     * x distance from the first endpoint to point being tested. <li>y13 y
     * distance from the first endpoint to point being tested. <li>x23 x
     * distance from the second endpoint to point being tested. <li>y23 y
     * distance from the second endpoint to point being tested. <li>D12 Length
     * of the line segment. <li>pp distance along the line segment to the
     * intersection of the perpendicular from the point to line extended. </ul>
     *
     * Procedure: <p>
     *
     ...
     * travels from the start point to the end point. <p>
     *
     * @param x1 line x coord1
     * @param y1 line y coord1
     * @param x2 line x coord2
    ...
    /**
     * Generates a line with width lw, returns an ArrayList of 4 x-y coords. <p>
     *
     * @param lw line width
     * @param x1 line x coord1
     * @param y1 line y coord1
    ...
    /**
     * Generates a polygon or polyline with positive width lw. <p> Returns
     * ArrayList of x-y array pairs of coordinates of polygon segments. the
     * parameter altx must either be null, or an alternate array of points to
     * draw. <p>
     *
     * @param lw line width
